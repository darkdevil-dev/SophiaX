...
from SophiaX import app
from SophiaX.core.call import Sophia
from SophiaX.misc import db
from SophiaX.utils.database import get_assistant, get_authuser_names, get_cmode
from SophiaX.utils.decorators import ActualAdminCB, AdminActual, language
from SophiaX.utils.formatters import alpha_to_int, get_readable_time
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Sophia.stop_stream_force(message.chat.id)
    except:
        pass
    ...
    if chat_id:
        ...
        try:
            db[chat_id] = []
            await Sophia.stop_stream_force(chat_id)
        except:
            pass
