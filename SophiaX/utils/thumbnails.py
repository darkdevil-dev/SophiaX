...
async def get_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("SophiaX/assets/font2.ttf", 30)
        font = ImageFont.truetype("SophiaX/assets/font.ttf", 30)
        title_font = ImageFont.truetype("SophiaX/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("SophiaX/assets/play_icons.png")
